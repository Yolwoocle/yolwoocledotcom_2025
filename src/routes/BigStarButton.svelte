<script lang="ts">
    ...
    const styles: Record<1|2|3, StyleDef> = {
        ...
        2: {
            outerPath: "M204.295 28.6641L205.176 29.1201L206.155 29.2686L253.249 36.4053L274.591 78.9893L275.035 79.875L275.74 80.5713L309.645 114.027L301.88 161.021L301.719 162L301.88 162.979L309.645 209.972L275.74 243.429L275.035 244.125L274.591 245.011L253.249 287.594L206.155 294.731L205.176 294.88L204.295 295.336L162 317.242L119.705 295.336L118.824 294.88L117.845 294.731L70.75 287.594L49.4092 245.011L48.9648 244.125L48.2598 243.429L14.3545 209.972L22.1201 162.979L22.2812 162L22.1201 161.021L14.3545 114.027L48.2598 80.5713L48.9648 79.875L49.4092 78.9893L70.75 36.4053L117.845 29.2686L118.824 29.1201L119.705 28.6641L162 6.75684L204.295 28.6641Z",
            innerPath: "M162 29L199.4 46.8936L240.175 54.4007L259.915 90.8604L288.491 120.901L283.03 162L288.491 203.099L259.915 233.14L240.175 269.599L199.4 277.106L162 295L124.6 277.106L83.8246 269.599L64.0847 233.14L35.5095 203.099L40.97 162L35.5095 120.901L64.0847 90.8604L83.8246 54.4007L124.6 46.8936L162 29Z",

            colorMain: "var(--blue-main)",
            colorSec:  "var(--blue-sec)",
            colorShad: "var(--blue-shad)",
        ...
        3: {
            outerPath: "M147.5 19.9189C156.473 14.7386 167.527 14.7386 176.5 19.9189L277.796 78.4023C286.768 83.5827 292.296 93.1559 292.296 103.517V220.483C292.296 230.844 286.768 240.417 277.796 245.598L176.5 304.081C167.527 309.261 156.473 309.261 147.5 304.081L46.2041 245.598C37.2315 240.417 31.7041 230.844 31.7041 220.483V103.517C31.7041 93.1559 37.2315 83.5827 46.2041 78.4023L147.5 19.9189Z",
            innerPath: "M152.5 61.4848C158.379 58.0908 165.621 58.0908 171.5 61.4848L244.299 103.515C250.177 106.909 253.799 113.182 253.799 119.97V204.03C253.799 210.818 250.177 217.091 244.299 220.485L171.5 262.515C165.621 265.909 158.379 265.909 152.5 262.515L79.7013 220.485C73.8227 217.091 70.2013 210.818 70.2013 204.03V119.97C70.2013 113.182 73.8227 106.909 79.7013 103.515L152.5 61.4848Z",

            colorMain: "var(--pink-main)",
            colorSec:  "var(--pink-sec)",
            colorShad: "var(--pink-shad)",
            colorText: "var(--pink-text)",
...
<a {href} class="group star-button button-style-{buttonStyle}">
	...
	>
        ...
        {#each Array(6) as _, i}
            <path
                ...
                stroke-width={styles[buttonStyle].outerStrokeWidth}
                d={styles[buttonStyle].outerPath}
                fill={styles[buttonStyle].colorShad}
                stroke={styles[buttonStyle].colorShad}
            />
        {/each}
        ...
        >
            <path
                d={styles[buttonStyle].outerPath}
                fill={styles[buttonStyle].colorMain}
                stroke={styles[buttonStyle].colorSec}
                stroke-width={styles[buttonStyle].outerStrokeWidth}
            />
            <path
	...
	<span
		class={cn(
            `text-[${styles[buttonStyle].colorText}] text-${styles[buttonStyle].textSize}`, 
