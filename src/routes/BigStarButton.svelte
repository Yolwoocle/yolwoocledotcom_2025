<script lang="ts">
	...
	let { text, buttonStyle, href } = $props();
</script>
...
<a {href} class="group star-button button-style-{buttonStyle}">
	...
	>
		{#if buttonStyle == 1}
			...
			{#each Array(6) as _, i}
				<path
					...
					class={cn(
						'fill-(--yellow-shad) stroke-(--yellow-shad)',
						// hover
		...
		{:else if buttonStyle == 2}
			...
			<!-- <g class="">
				<path d="M204.295 28.6641L205.176 29.1201L206.155 29.2686L253.249 36.4053L274.591 78.9893L275.035 79.875L275.74 80.5713L309.645 114.027L301.88 161.021L301.719 162L301.88 162.979L309.645 209.972L275.74 243.429L275.035 244.125L274.591 245.011L253.249 287.594L206.155 294.731L205.176 294.88L204.295 295.336L162 317.242L119.705 295.336L118.824 294.88L117.845 294.731L70.75 287.594L49.4092 245.011L48.9648 244.125L48.2598 243.429L14.3545 209.972L22.1201 162.979L22.2812 162L22.1201 161.021L14.3545 114.027L48.2598 80.5713L48.9648 79.875L49.4092 78.9893L70.75 36.4053L117.845 29.2686L118.824 29.1201L119.705 28.6641L162 6.75684L204.295 28.6641Z" fill="#97D1C1" stroke="#67ABB4" stroke-width="12"/>
			</g> -->
		{:else if buttonStyle == 3}
			<g class="star-shape-group">
				<path
					d="M147.5 19.9189C156.473 14.7386 167.527 14.7386 176.5 19.9189L277.796 78.4023C286.768 83.5827 292.296 93.1559 292.296 103.517V220.483C292.296 230.844 286.768 240.417 277.796 245.598L176.5 304.081C167.527 309.261 156.473 309.261 147.5 304.081L46.2041 245.598C37.2315 240.417 31.7041 230.844 31.7041 220.483V103.517C31.7041 93.1559 37.2315 83.5827 46.2041 78.4023L147.5 19.9189Z"
					fill="#EAA6A7"
					stroke="#D57487"
					stroke-width="20"
				/>
				<path
					d="M152.5 61.4848C158.379 58.0908 165.621 58.0908 171.5 61.4848L244.299 103.515C250.177 106.909 253.799 113.182 253.799 119.97V204.03C253.799 210.818 250.177 217.091 244.299 220.485L171.5 262.515C165.621 265.909 158.379 265.909 152.5 262.515L79.7013 220.485C73.8227 217.091 70.2013 210.818 70.2013 204.03V119.97C70.2013 113.182 73.8227 106.909 79.7013 103.515L152.5 61.4848Z"
					fill="#EAA6A7"
					stroke="#D57487"
					stroke-width="15"
				/>
	...
	<span
		class="group-active:text-shadow-[1px_1px_0_var(--transp-shad)] absolute top-1/2 left-1/2 text-(--yellow-text) text-2xl group-hover:text-shadow-[2px_6px_0_var(--transp-shad)] -translate-x-1/2 -translate-y-1/2 group-hover:translate-y-[calc(-50%-18px)] group-active:translate-y-[calc(-50%+10px)] transition-[transform,text-shadow,translate,scale,rotate] ease-(--ease-out-back) duration-300 text-shadow-[1px_4px_0_var(--transp-shad)]"
		>{text}</span
	>
</a>
...
<style>
	...
	.star-shape-style-1 {
		/* filter: 
            drop-shadow( 0px 4px 0 var(--yellow-shad) )
            drop-shadow( 0px 4px 0 var(--yellow-shad) )
            drop-shadow( 0px 4px 0 var(--yellow-shad) )
            drop-shadow( 0px 4px 0 var(--yellow-shad) )
            drop-shadow( 0px 4px 0 var(--yellow-shad) )
            drop-shadow( 3px 11px 0 var(--transp-shad) ); */
	}

	.star-shape-style-2 {
		filter: drop-shadow(0px 2px 0 var(--blue-shad)) drop-shadow(0px 2px 0 var(--blue-shad))
			drop-shadow(0px 2px 0 var(--blue-shad)) drop-shadow(0px 2px 0 var(--blue-shad))
			drop-shadow(0px 2px 0 var(--blue-shad)) drop-shadow(0px 2px 0 var(--blue-shad))
			drop-shadow(0px 2px 0 var(--blue-shad)) drop-shadow(0px 2px 0 var(--blue-shad))
			drop-shadow(0px 2px 0 var(--blue-shad)) drop-shadow(0px 2px 0 var(--blue-shad))
			drop-shadow(3px 11px 0 var(--transp-shad));
	...
	.star-shape-style-3 {
		filter: drop-shadow(0px 2px 0 var(--pink-shad)) drop-shadow(0px 4px 0 var(--pink-shad))
			drop-shadow(0px 6px 0 var(--pink-shad)) drop-shadow(2px 6px 0 var(--transp-shad));
	}

	.text-style-1 {
		color: var(--yellow-text);

		text-shadow: 1px 4px 0 var(--transp-shad);
	}
	...
	.text-style-3 {
		...
		text-shadow: 1px 2px 0 var(--transp-shad);
	}
	...
	.star-button:hover .star-shape-style-1,
	.star-button:hover .star-shape-style-2 {
		top: -12px;
	}

	.star-button:hover .star-shape-style-3 {
		top: -6px;
	}

	.star-button:hover .star-shape-group {
		transform: rotate(30deg);
	}

	.star-button:hover .star-shape-style-1 {
		/* filter: 
            drop-shadow( 0px 6px 0 var(--yellow-shad) )
            drop-shadow( 0px 6px 0 var(--yellow-shad) )
            drop-shadow( 0px 6px 0 var(--yellow-shad) )
            drop-shadow( 0px 6px 0 var(--yellow-shad) )
            drop-shadow( 0px 6px 0 var(--yellow-shad) )
            drop-shadow( 5px 16px 0 var(--transp-shad) ); */
	}

	.star-button:hover .star-shape-style-2 {
		filter: drop-shadow(0px 3px 0 var(--blue-shad)) drop-shadow(0px 3px 0 var(--blue-shad))
			drop-shadow(0px 3px 0 var(--blue-shad)) drop-shadow(0px 3px 0 var(--blue-shad))
			drop-shadow(0px 3px 0 var(--blue-shad)) drop-shadow(0px 3px 0 var(--blue-shad))
			drop-shadow(0px 3px 0 var(--blue-shad)) drop-shadow(0px 3px 0 var(--blue-shad))
			drop-shadow(0px 3px 0 var(--blue-shad)) drop-shadow(0px 3px 0 var(--blue-shad))
			drop-shadow(5px 16px 0 var(--transp-shad));
	...
	.star-button:hover .star-shape-style-3 {
		filter: drop-shadow(0px 2px 0 var(--pink-shad)) drop-shadow(0px 6px 0 var(--pink-shad))
			drop-shadow(0px 10px 0 var(--pink-shad)) drop-shadow(3px 10px 0 var(--transp-shad));
	}

	.star-button:hover .text-style-2 {
		top: calc(50% - 18px);

		text-shadow: 2px 6px 0 var(--transp-shad);
	}

	.star-button:hover .text-style-3 {
		top: calc(50% - 12px);
	...
	.star-button:active .star-shape-style-1 {
		filter: drop-shadow(0px 2px 0 var(--yellow-shad)) drop-shadow(0px 2px 0 var(--yellow-shad))
			drop-shadow(0px 2px 0 var(--yellow-shad)) drop-shadow(0px 2px 0 var(--yellow-shad))
			drop-shadow(0px 2px 0 var(--yellow-shad)) drop-shadow(2px 5px 0 var(--transp-shad));
	}

	.star-button:active .star-shape-style-2 {
		filter: drop-shadow(0px 1px 0 var(--blue-shad)) drop-shadow(0px 1px 0 var(--blue-shad))
			drop-shadow(0px 1px 0 var(--blue-shad)) drop-shadow(0px 1px 0 var(--blue-shad))
			drop-shadow(0px 1px 0 var(--blue-shad)) drop-shadow(0px 1px 0 var(--blue-shad))
			drop-shadow(0px 1px 0 var(--blue-shad)) drop-shadow(0px 1px 0 var(--blue-shad))
			drop-shadow(0px 1px 0 var(--blue-shad)) drop-shadow(0px 1px 0 var(--blue-shad))
	...
	.star-button:active .star-shape-style-3 {
		filter: drop-shadow(0px 3px 0 var(--pink-shad)) drop-shadow(0px 3px 0 var(--pink-shad))
			drop-shadow(0px 4px 0 var(--pink-shad)) drop-shadow(1px 5px 0 var(--transp-shad));
	}
	...
	.star-button:active .text-style-2 {
		top: calc(50% + 10px);

		text-shadow: 1px 1px 0 var(--transp-shad);
	}
